            ...
            if (destination != null) {
                if (destination.hasAvailableQuota(length)) {
                    try {
                        ...
                        VaadinHelper.showException(getApplication(), ccfe);
                    };
                } else {
        ...
        private class NodePanel extends Panel {
            ...
            private class DownloadButton extends Link {
                ...
                public void attach() {
                    ...
                    final String url = VaadinHelper.getDownloadUrl(application, document);
                    ...
                    public void handleAction(final Object sender, final Object target) {
                        ...
                        if (selectedNode instanceof DirNode) {
                            try {
                                ...
                                VaadinHelper.showException(getApplication(), e);
                            }
                        }
