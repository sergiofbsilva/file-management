...
public class ContextPath {
	...
	public ContextPath subContextPath(DirNode dirNode) {
		final int dirNodeIndex = contextPath.indexOf(dirNode);
		if (dirNodeIndex == -1) {
			return this;
		} else {
			return new ContextPath(contextPath.subList(0, dirNodeIndex + 1));
		}
	}
