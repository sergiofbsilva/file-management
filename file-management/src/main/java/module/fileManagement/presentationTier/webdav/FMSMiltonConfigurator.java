...
public class FMSMiltonConfigurator extends DefaultMiltonConfigurator {
	...
	final ExpiredNonceRemover expiredNonceRemover = new ExpiredNonceRemover(builder.getNonces(),
		builder.getNonceValiditySeconds());
	builder.setExpiredNonceRemover(expiredNonceRemover);

	final SimpleMemoryNonceProvider nonceProvider = new SimpleMemoryNonceProvider(builder.getNonceValiditySeconds(),
		expiredNonceRemover, builder.getNonces());
