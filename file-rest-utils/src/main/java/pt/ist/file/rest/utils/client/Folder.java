...
public class Folder implements IFolder {
	...
	final String documentOid = getWebResource().path("upload").path(getRemoteExternalId())
		.type(MediaType.MULTIPART_FORM_DATA_TYPE).post(String.class, formDataMultiPart);
